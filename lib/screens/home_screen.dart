                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                '\$${(invoiceProvider.unpaidTotal + invoiceProvider.paidTotal).toStringAsFixed(2)}',
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  '\$${invoiceProvider.unpaidTotal.toStringAsFixed(2)}',
                                  style: const TextStyle(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  '\$${invoiceProvider.paidTotal.toStringAsFixed(2)}',
                                  style: const TextStyle(
                                    color: AppTheme.textPrimaryColor,
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold,
